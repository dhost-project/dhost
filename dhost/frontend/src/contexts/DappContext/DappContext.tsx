...
export const DappContext: Context<Partial<DappContextType>> = createContext<Partial<DappContextType>>({});
...
return (
  <DappContext.Provider value={props}>
    {children}
  </DappContext.Provider>
);
}

export const useDapp = (): DappContextType => useContext(DappContext) as DappContextType;