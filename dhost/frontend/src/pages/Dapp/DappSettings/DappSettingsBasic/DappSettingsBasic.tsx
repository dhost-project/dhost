import { DappContextType, DappContext, useDapp } from 'contexts/DappContext/DappContext';
...
function DappSettingsBasic({ dapp, setDapp }: DappContextType): React.ReactElement {
  ...
  return (
    <div>
      <div className="pb-4 w-1/2">
        <h2 className="block uppercase tracking-wide text-gray-700 text-xs font-medium mb-2">Name</h2>
