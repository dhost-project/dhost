    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.FilePathField(allow_files=False, allow_folders=True, blank=True, max_length=1024, null=True, path=dhost.builds.models.source_path, recursive=True, verbose_name='Source folder')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.FilePathField(allow_files=False, allow_folders=True, blank=True, help_text='Source folder', max_length=1024, null=True, path=dhost.builds.models.source_path, recursive=True)),
                ('bundle', models.FilePathField(allow_files=False, allow_folders=True, blank=True, help_text='Bundle folder', max_length=1024, null=True, path=dhost.builds.models.bundle_path, recursive=True)),
